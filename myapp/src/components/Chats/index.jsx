...
const chatLists = [
    { id: "chat1", name: "First", img: "https://mui.com/static/images/avatar/1.jpg" },
    { id: "chat2", name: "Second", img: "https://mui.com/static/images/avatar/2.jpg" },
    { id: "chat3", name: "Third", img: "https://mui.com/static/images/avatar/3.jpg" },
...
export const Chats = () => {
    ...
    const handleAddChat = useCallback((name) => {
        let id = 0;
        if (chats.length !== 0) {
            id = +chats[chats.length - 1].id.substring(3) + 1;
        }
